...
export default function SplashCursor({
  ...
  BACK_COLOR = { r: 0.145, g: 0.145, b: 0.145 }, // Matches your dark theme background
  TRANSPARENT = true,
}: SplashCursorProps) {
  ...
  useEffect(() => {
    ...
    function generateColor(): ColorRGB {
      // Use a color palette that matches IntentFi's theme
      const themes = [
        // Based on your theme colors from globals.css
        { h: 264.376 / 360, s: 1.0, v: 0.9 }, // --sidebar-primary (purple) in dark mode
        { h: 162.48 / 360, s: 0.9, v: 0.9 }, // --chart-2 (teal) in dark mode
        { h: 70.08 / 360, s: 0.9, v: 0.9 }, // --chart-3 (yellowish) in dark mode
        { h: 303.9 / 360, s: 0.9, v: 0.9 }, // --chart-4 (pink) in dark mode
        { h: 16.439 / 360, s: 0.9, v: 0.9 }, // --chart-5 (orange) in dark mode
      ];

      // Pick a random theme color
      const theme = themes[Math.floor(Math.random() * themes.length)];
      const c = HSVtoRGB(theme.h, theme.s, theme.v);

      // Adjust brightness to be visually appealing with the dark background
      c.r *= 0.7;
      c.g *= 0.7;
      c.b *= 0.7;
